package io.webnostic.citydata.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("CityDataService");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("CityDataService");
        ...
        config.getMapConfigs().put("io.webnostic.citydata.domain.*", initializeDomainMapConfig(jHipsterProperties));
